...
def create_calendar_event(
    start_time: str, summary: str, description: str, attendees: list[str]
) -> dict:
    ...
    if start.date() == now_sast.date():
        raise ValueError(
            "Cannot book a same-day appointment. Please book for the next business day or later."
        )
    ...
    event = {
        ...
        "extendedProperties": {"private": {"lead_email": lead_email}},
    }
